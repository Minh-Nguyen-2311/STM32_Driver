...
C_SRCS += \
../Core/Src/Console/Audio_Console.c \
../Core/Src/Console/OOP.c 

OBJS += \
./Core/Src/Console/Audio_Console.o \
./Core/Src/Console/OOP.o 

C_DEPS += \
./Core/Src/Console/Audio_Console.d \
...
clean-Core-2f-Src-2f-Console:
	-$(RM) ./Core/Src/Console/Audio_Console.d ./Core/Src/Console/Audio_Console.o ./Core/Src/Console/Audio_Console.su ./Core/Src/Console/OOP.d ./Core/Src/Console/OOP.o ./Core/Src/Console/OOP.su
